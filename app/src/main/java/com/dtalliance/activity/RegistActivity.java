...
import com.dtalliance.sevice.UserServiceNew;
import com.dtalliance.util.ValidateStr;
...
//		introduce = introduceET.getText().toString().trim();
		...
		if(passwd.isEmpty() || !(repasswd.equals(passwd))){
			Toast.makeText(getApplicationContext(), R.string.passwdNotEqual, Toast.LENGTH_SHORT).show();
			return flag;
		}
